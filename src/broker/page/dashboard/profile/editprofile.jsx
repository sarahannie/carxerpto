          ...
          {activeStep === 1 && (
            <form className="border shadow-lg p-4 mb-3 rounded-lg">
              ...
              {formik.touched.specialities && formik.errors.specialities ? (
                <div className="text-red-500 text-sm">{formik.errors.specialities}</div>
              ) : null}
              <Textarea 
                type="text" 
                label="Expertise" 
            ...
            <form className="border shadow-lg p-4 mb-3 rounded-lg" onSubmit={formik.handleSubmit}>
              ...
              <div className="my-2">
                ...
                {formik.touched.totalTransaction && formik.errors.totalTransaction ? (
                  <div className="text-red-500 text-sm">{formik.errors.totalTransaction}</div>
                ) : null}
              </div>
              <div className="my-2">
                <Input 
                ...
                {formik.touched.avgSalePrice && formik.errors.avgSalePrice ? (
                  <div className="text-red-500 text-sm">{formik.errors.avgSalePrice}</div>
                ) : null}
              </div>
              <div className="my-2">
                <Input 
                ...
                {formik.touched.clientSatisfaction && formik.errors.clientSatisfaction ? (
                  <div className="text-red-500 text-sm">{formik.errors.clientSatisfaction}</div>
                ) : null}
              </div>
              <Button className="w-full bg-primary-normal" type="submit">{isLoading ? 'Updating...' : 'Save'}</Button>
            </form>
          )}
        </div>
      </div>
