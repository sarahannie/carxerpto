...
import cardCardA from  "../../assets/carCardC.jpg"
import { useGetPickupTrucksCategoryProductsQuery } from '../../app/api/buyerProductApi.js';
import {useNavigate } from 'react-router-dom';


function CategoryCardPickupTrucks() {
  const navigate = useNavigate();
  const { data} = useGetPickupTrucksCategoryProductsQuery();
...
export default CategoryCardPickupTrucks;
