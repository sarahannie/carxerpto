...
import cardCardA from  "../../assets/carCardB.jpg"
import { useGetSuvCategoryProductsQuery } from '../../app/api/buyerProductApi.js';
import {useNavigate } from 'react-router-dom';


function CategoryCardSuv() {
  const navigate = useNavigate();
  const { data } = useGetSuvCategoryProductsQuery();
...
export default CategoryCardSuv;
