...
import { useGetHatchbacksCategoryProductsQuery } from '../../app/api/buyerProductApi.js';
import {useNavigate } from 'react-router-dom';


function CategoryHatchbacks() {
  const navigate = useNavigate();
  const { data } = useGetHatchbacksCategoryProductsQuery();
...
export default CategoryHatchbacks;
