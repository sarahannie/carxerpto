        ...
        <div className="mx-8 lg:mx-0 flex justify-center items-center h-screen mt-[50px]">
          <div className='-mt-20 lg:mx-0 w-80 h-[220px] lg:w-96 z-10 bg-accent-white pb-12'>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <button type="submit" className='w-60 lg:w-80 bg-primary-normal text-white py-3 rounded mt-3 hover:bg-secondary-normalhover hover:text-accent-white transition duration-300'>Verify Email</button>
            </form>
            <button onClick={handleResendOtp} className='mt-4 text-sm text-blue-500 hover:underline'>Resend OTP</button>
          </div>
        </div>
      </div>
    </div>
